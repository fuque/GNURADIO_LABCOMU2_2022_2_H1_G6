...
# Author: G6_H1
# Copyright: UIS
# Description: Modulaciones ASK en GNURadio
...
class Practica2_labComu2_G6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica2_labComu2_G6")
        ...
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "Coeficiente de Estabilidad Ka", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Practica2_labComu2_G6, options=None):
