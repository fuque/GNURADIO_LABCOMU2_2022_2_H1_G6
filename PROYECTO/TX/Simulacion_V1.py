...
class Simulacion_V1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(2, 3):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._freq_range = Range(100e3, 3000e6, 10, 50e6, 200)
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_edit_box_msg_0_0 = qtgui.edit_box_msg(qtgui.STRING, 'Este es un mensaje enviado desde el banco 8', '', False, True, '', None)
