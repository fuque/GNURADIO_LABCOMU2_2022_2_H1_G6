...
class Simulacion_V1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK_RX_HACK_HDLC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK_RX_HACK_HDLC")
        ...
        self.Sps = Sps = 4
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_cma( qpsk, .001, 4).base()
        self.timing_loop_bw = timing_loop_bw = 6.28/100.0
        self.squelch = squelch = -150
        self.samp_rate = samp_rate = 2e6
        self.rrc_taps_0 = rrc_taps_0 = firdes.root_raised_cosine(nfilts, nfilts,1/float(Sps), 0.35, (11*Sps*nfilts))
        self.qpsk_2 = qpsk_2 = digital.constellation_qpsk().base()
        self.phase_bw = phase_bw = 6.28/100.0
        self.ntaps = ntaps = Sps*128
        self.if_gain = if_gain = 31.5
        self.freq = freq = 2240E6
        ...
        self._squelch_range = Range(-150, -50, 1, -150, 200)
        self._squelch_win = RangeWidget(self._squelch_range, self.set_squelch, "squelch", "counter_slider", float, QtCore.Qt.Horizontal)
        self.controls_grid_layout_0.addWidget(self._squelch_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.controls_grid_layout_0.setRowStretch(r, 1)
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._samp_rate_range = Range(1e6, 20e6, 1e6, 2e6, 200)
        ...
        self.uhd_usrp_source_0.set_center_freq(freq-500e3, 0)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                2,
                samp_rate,
                ((samp_rate/(2*Sps)) *( excess_bw +1)),
                (((samp_rate/(2*Sps)) *( excess_bw +1))*0.3),
                window.WIN_HAMMING,
                6.76))
        ...
        for c in range(1, 2):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(Sps, timing_loop_bw, rrc_taps_0, nfilts, (nfilts/2), 1.5, 2)
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, 2, variable_adaptive_algorithm_0, False, [ ], 'corr_est')
        ...
        self.connect((self.satellites_nrzi_decode_0, 0), (self.blocks_char_to_float_0_0, 0))
    ...
    def set_nfilts(self, nfilts):
        self.nfilts = nfilts
        self.set_rrc_taps_0(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1/float(self.Sps), 0.35, (11*self.Sps*self.nfilts)))
    ...
    def set_Sps(self, Sps):
        self.Sps = Sps
        self.set_ntaps(self.Sps*128)
        self.set_rrc_taps_0(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1/float(self.Sps), 0.35, (11*self.Sps*self.nfilts)))
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, ((self.samp_rate/(2*self.Sps)) *( self.excess_bw +1)), (((self.samp_rate/(2*self.Sps)) *( self.excess_bw +1))*0.3), window.WIN_HAMMING, 6.76))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.uhd_usrp_source_0.set_center_freq(self.freq-500e3, 0)
